            ...
            <div class="col-xs-6" id="content_right">
                ...
                <div id="content_right_information">
                    ...
                    <p class="content_right_phone">
                        <img src="./asset/image/content/contact_us/phone.png" class="content_search_no_found_logo" id="content_search_no_found_logo_phone"/> (+62) 31 999 999
                    </p>
                    <p class="content_right_fax">
                        <img src="./asset/image/content/contact_us/fax.png" class="content_search_no_found_logo" id="content_search_no_found_logo_fax"/> (+62) 31 999 999
                    </p>
